...
public class MovieProgram {
    ...
    public void createProgramForTheNextThreeMonths() {
        ...
        Movie movie1 = new Movie("Haha, you're dead!", null, "Comedy", 123, "For the whole family.", null, 80, "Mr. Movie Director", 0, null);
        ...
        Movie movie2 = new Movie("Gotta save the world.", null, "Action", 123, "A retired man is asked by the president to save the world. And he does.", null, 80, "Mr. Movie Director", 0, null);
        ...
        Movie movie3 = new Movie("Ghost Nuns 2", null, "Horror", 123, "Diapers will be provided.", null, 80, "Mr. Movie Director", 16, null);
